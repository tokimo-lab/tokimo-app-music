    ...
    <div className="absolute inset-0 z-10 flex justify-end">
      ...
      <div
        ...
        className={cn(
          ...
          "bg-[var(--modal-bg)] shadow-2xl backdrop-blur-xl",
          ...
          <div className="flex items-center gap-1">
            {queue.length > 0 && (
              <button
                type="button"
                onClick={clearQueue}
                className="flex items-center gap-1 rounded-md px-2 py-1 text-xs text-[var(--text-muted)] hover:bg-[var(--fill-tertiary)] hover:text-red-500"
              >
            ...
            <button
              type="button"
              onClick={onClose}
              className="flex h-7 w-7 items-center justify-center rounded-md text-[var(--text-muted)] hover:bg-[var(--fill-tertiary)]"
            >
              <X className="h-4 w-4" />
            </button>
          </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex h-6 w-6 flex-shrink-0 items-center justify-center">
                      {isCurrent ? (
                        <div className="flex items-end gap-[2px]">
                          <span className="inline-block h-3 w-[3px] animate-bounce rounded-sm bg-[var(--accent)] [animation-delay:0ms]" />
                          <span className="inline-block h-4 w-[3px] animate-bounce rounded-sm bg-[var(--accent)] [animation-delay:150ms]" />
                          <span className="inline-block h-2 w-[3px] animate-bounce rounded-sm bg-[var(--accent)] [animation-delay:300ms]" />
                        </div>
                      ) : (
                        <button
                          type="button"
                    ...
                    <button
                      ...
                      className="flex h-6 w-6 flex-shrink-0 items-center justify-center rounded opacity-0 transition-opacity hover:bg-[var(--fill-tertiary)] group-hover:opacity-100"
                    >
