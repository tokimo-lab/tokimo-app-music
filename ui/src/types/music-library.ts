...
const MusicAlbumOutputSchema = z.object({
  id: z.string(),
  libraryId: z.string(),
  title: z.string(),
...
/** 专辑详情（含曲目、演职人员、流派） */
const MusicAlbumDetailOutputSchema = MusicAlbumOutputSchema.extend({
...
const MusicArtistOutputSchema = z.object({
  id: z.string(),
  name: z.string(),
...
/** 艺术家详情 */
const MusicArtistDetailOutputSchema = MusicArtistOutputSchema.extend({
...
/** 歌词查询结果 */
const TrackLyricsOutputSchema = z.object({
